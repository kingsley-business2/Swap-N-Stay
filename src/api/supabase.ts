// ========================== src/api/supabase.ts (TEMPORARY LOGGING ADDED) ==========================
...
// 💡 TEMPORARY LOGGING ADDED: Check these values in your browser console (F12)
console.log('Initializing Supabase...');
console.log('URL:', supabaseUrl);
console.log('Key (Partial):', supabaseAnonKey.substring(0, 10) + '...'); 
